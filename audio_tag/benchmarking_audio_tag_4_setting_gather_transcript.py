...
file_suffixs = ['_1.json', '_2.json', '_3.json', '_4.json']
default_transcript = []
...
df.to_csv("samples/default_transcript.txt", index=False, header=False)
df = pd.DataFrame(no_padding_transcript)
df.to_csv("samples/no_padding_transcript.txt", index=False, header=False)
df = pd.DataFrame(ours_transcript)
df.to_csv("samples/ours_transcript.txt", index=False, header=False)
df = pd.DataFrame(zero_padding_transcript)
df.to_csv("samples/zero_padding_transcript.txt", index=False, header=False)
