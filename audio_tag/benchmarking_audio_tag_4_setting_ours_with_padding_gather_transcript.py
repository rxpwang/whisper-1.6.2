...
file_suffixs = ['_ours_wn_prefix_0.5.json', '_ours_wn_prefix_1.json', '_ours_wn_suffix_0.5.json', '_ours_wn_suffix_1.json']
default_transcript = []
...
df.to_csv("samples/ours_wn_prefix_0.5.txt", index=False, header=False)
df = pd.DataFrame(no_padding_transcript)
df.to_csv("samples/ours_wn_prefix_1.txt", index=False, header=False)
df = pd.DataFrame(ours_transcript)
df.to_csv("samples/ours_wn_suffix_0.5.txt", index=False, header=False)
df = pd.DataFrame(zero_padding_transcript)
df.to_csv("samples/ours_wn_suffix_1.txt", index=False, header=False)
