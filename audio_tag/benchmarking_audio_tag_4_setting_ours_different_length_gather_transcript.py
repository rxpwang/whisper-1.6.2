...
file_suffixs = ['_ours_0.5_avg.json', '_ours_1_avg.json', '_ours_1.5_avg.json', '_ours_2_avg.json']
default_transcript = []
...
df.to_csv("samples/ours_0.5_avg.txt", index=False, header=False)
df = pd.DataFrame(no_padding_transcript)
df.to_csv("samples/ours_1_avg.txt", index=False, header=False)
df = pd.DataFrame(ours_transcript)
df.to_csv("samples/ours_1.5_avg.txt", index=False, header=False)
df = pd.DataFrame(zero_padding_transcript)
df.to_csv("samples/ours_2_avg.txt", index=False, header=False)
