...
void MainWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->onConfirmedTokens((*reinterpret_cast< std::add_pointer_t<std::vector<std::tuple<double,double,std::string>>>>(_a[1]))); break;
        case 3: _t->onUnconfirmedTokens((*reinterpret_cast< std::add_pointer_t<std::vector<std::tuple<double,double,std::string>>>>(_a[1]))); break;
        default: ;
        }
    }
}
